...
public class Informacao6 {
    ...
    public static class ReducerInformacao6 extends Reducer<Text, IntWritable, Text, IntWritable> {
        ...
        public void cleanup(Context context) throws IOException, InterruptedException {
            context.write(new Text("Mercadoria com mais transações financeiras em 2016 no Brasil:"), maxTransacoes);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String arquivoSaida = "/Users/valmirfilho/NetBeansProjects/implementacaoMapReduce/src/main/java/mycompany/implementacaomapreduce/informacao6";
